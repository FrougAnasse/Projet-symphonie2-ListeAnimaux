...
class __TwigTemplate_d6e3692e8e3bd7b8171639e12c369db824229a1cf2fd7dd7e99beef0729fc7f3 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["animaux"]) || array_key_exists("animaux", $context) ? $context["animaux"] : (function () { throw new RuntimeError('Variable "animaux" does not exist.', 9, $this->source); })()));
        ...
        <div class=\"col-2 text-center\">
            ...
            echo "\" 
                alt='";
            // line 13
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["animal"], "image", [], "any", false, false, false, 13), "html", null, true);
            echo "'/>
        </div>
        <div class=\"col-auto\">
           <h2> <a href=\"";
...
{% block monTitre %}Liste Animaux{% endblock %}
{% block body %}
...
{% endblock %}
", "animal/index.html.twig", "C:\\Users\\VolgoBox\\Desktop\\formation Symfony\\ListeAnimaux\\templates\\animal\\index.html.twig");
    }
}
